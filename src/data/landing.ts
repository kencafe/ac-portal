...
export const SERVICES_META = [
  ...
  { num: 3, name: "AIOps", en: "Deploy & operate", slug: "aiops", accent: "green",
  ...
  { num: 6, name: "Cloud & Hạ tầng AI", en: "Cloud & AI Infrastructure", slug: "cloudai", accent: "blue",
    desc: "Nền tảng dữ liệu + hạ tầng GPU/MLOps cho toàn vòng đời AI/ML, tới phục vụ mô hình & LLM.",
    descEn: "Data platform + GPU/MLOps infrastructure across the AI/ML lifecycle, through model & LLM serving." },
  ...
  { num: 10, name: "Thuê kỹ sư theo vị trí", nameEn: "Engineer outsourcing", en: "Engineer outsourcing", slug: "outsourcing", accent: "blue",
  ...
  { num: 11, name: "ATTT theo luật VN", nameEn: "Vietnam IT-security compliance", en: "Vietnam IT-security compliance", slug: "attt", accent: "orange",
  ...
  { num: 12, name: "Cloud Managed Service", en: "Comprehensive managed service", slug: "managed", accent: "green",
  ...
  { num: 13, name: "Ứng cứu sự cố Cloud", nameEn: "Cloud incident response", en: "Cloud incident response", slug: "incident", accent: "orange",
...
export const MODEL = {
  ...
  phases: [
    { num: 1, phaseLabel: "Giai đoạn 01", phaseLabelEn: "Phase 01", title: "Tư vấn", en: "Consult", color: "#F37021", blogSlug: "tu-van-kien-truc",
    ...
    { num: 2, phaseLabel: "Giai đoạn 02", phaseLabelEn: "Phase 02", title: "Triển khai", en: "Deploy", color: "#0072BC", blogSlug: "trien-khai-go-live",
      chips: ["Landing zone", "Migrate", "CI/CD", "Nền tảng AIOps", "Go-live"],
      chipsEn: ["Landing zone", "Migrate", "CI/CD", "AIOps platform", "Go-live"] },
    { num: 3, phaseLabel: "Giai đoạn 03", phaseLabelEn: "Phase 03", title: "Vận hành", en: "Operate", color: "#38A3D8", blogSlug: "van-hanh-24-7",
    ...
    { num: 4, phaseLabel: "Giai đoạn 04", phaseLabelEn: "Phase 04", title: "Tối ưu", en: "Optimize", color: "#57A336", blogSlug: "toi-uu-lien-tuc",
...
export const PARTNERS = [
  { id: "partner-redhat", name: "Red Hat", desc: "RHEL · OpenShift · Ansible", descEn: "RHEL · OpenShift · Ansible",
    logo: "https://cdn.simpleicons.org/redhat", placeholderHint: "Red Hat" },
  { id: "partner-ibm", name: "IBM", desc: "Hạ tầng & phần mềm doanh nghiệp", descEn: "Enterprise infrastructure & software",
    logo: "https://cdn.simpleicons.org/ibm", placeholderHint: "IBM" },
  { id: "partner-vmware", name: "VMware", desc: "Ảo hoá, private cloud & Tanzu", descEn: "Virtualization, private cloud & Tanzu",
    logo: "https://cdn.simpleicons.org/vmware", placeholderHint: "VMware" },
  { id: "partner-dellemc", name: "Dell EMC", desc: "Máy chủ & lưu trữ doanh nghiệp", descEn: "Enterprise servers & storage",
    logo: "https://cdn.simpleicons.org/dell", placeholderHint: "Dell EMC" },
  { id: "partner-hpe", name: "HPE", desc: "Máy chủ & hạ tầng lai", descEn: "Servers & hybrid infrastructure",
    logo: "https://cdn.simpleicons.org/hewlettpackardenterprise", placeholderHint: "HPE" },
  { id: "partner-supermicro", name: "Supermicro", desc: "Máy chủ GPU & hiệu năng cao", descEn: "GPU & high-performance servers",
    logo: "https://cdn.simpleicons.org/supermicro", placeholderHint: "Supermicro" },
...
export const CASES = [
  ...
  },
  {
    ...
    logos: [
      ...
      { id: "logo-tradeflat", src: "assets/logo-tradeflat.png", placeholderHint: "Tradeflat" },
      { id: "logo-khaothi", src: "assets/logo-khaothi.png", placeholderHint: "Khảo Thí Online" },
      { id: "logo-baohiemfpt", src: "assets/logo-baohiemfpt.png", placeholderHint: "Bảo hiểm FPT" },
    ],
  },
] as const;
